    ...
    return (
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-zinc-950">
            <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
                Welcome Back to Melos
            </h2>
            <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
                Login to continue enjoying the features of Melos
            </p>

            <form className="my-8" onSubmit={handleSubmit(onSumbit)}>
                <LabelInputContainer className="mb-4">
                    <Label htmlFor="email">Email Address</Label>
                    <Input id="email" placeholder="useremail@gmail.com" type="email" {...register('email', { required: true })} />
                ...
                >
                    {loading ? (
                        <div className="w-4 h-4 border-4 border-t-4 border-transparent border-blue-500 rounded-full animate-spin mx-auto" />
                    ) : (
                        "Log In →"
                    )}
                    <BottomGradient />
